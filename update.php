...
while ($row = mysqli_fetch_assoc($currentValues)) {
   ...
   . "<tr><td>Last Name:</td><td><input type=\"text\" id=\"lastName\" name=\"lastname\" value=\"" . $row["lastname"] ."\"></td></tr>"
   . "<tr><td>Street Address Line 1:</td><td><input type=\"text\" id=\"streetLine1\" name=\"street_line1\"  value=\"" . $row["street_line1"] ."\"></td></tr>"
   . "<tr><td>Street Address Line 2:</td><td><input type=\"text\" id=\"streetLine2\"  name=\"street_line2\" value=\"" . $row["street_line2"] ."\"></td></tr>"
   . "<tr><td>City:</td><td><input type=\"text\" id=\"city\" name=\"city\" value=" . $row["city"] ."></td></tr>"
   . "<tr><td>Region:</td><td><input type=\"text\" id=\"region\" name=\"region\" value=\"" . $row["region"] ."\"></td></tr>"
   . "<tr><td>Postal:</td><td><input type=\"text\" id=\"postalCode\" name=\"postal\" value=\"" . $row["postal"] ."\"></td></tr>"
